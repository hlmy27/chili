...
module.exports = {
	...
	smtpServer: {
		...
		user: process.env.SMTP_USER || 'f11b9267518477',
		pass: process.env.SMTP_PASS || 'c77ec2c2384c51',
		fromName: process.env.SMTP_FROM_NAME || 'Chili Indonesia',
		fromAddress: process.env.SMTP_FROM_ADDRESS || 'Chili.id'
	},

	// key to sign tokens
	jwtSecretKey:
		process.env.JWT_SECRET_KEY ||
		'eyJhbGciOiJIUzUxMiJ9.eyJkYXRhIjp7InRva2VuIjoiZDIzMzU3MWQzZDNmNjA0OTUzOWFiOGM5M2NiYjc5ZDMifX0.f8VpflysrfJqSbcFNOLS3v7G5W-7yQpRrWqfFmbC7Y0JIVwx54-0MaGyWiu-65Qy1A9p-7YYFAs1-zebqtZFMw',

	// key to sign store cookies
	cookieSecretKey:
		process.env.COOKIE_SECRET_KEY || 'd233571d3d3f6049539ab8c93cbb79d3',
